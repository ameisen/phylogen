...
enum ImGuiButtonFlags_
{
   ...
   ImGuiButtonFlags_Current_PC = 1 << 8
};
...
namespace ImGui
{
    ...
    IMGUI_API bool          ButtonEx(const char* label, const ImVec2& size_arg, int flags);
    ...
    IMGUI_API bool          Checkbox(const char* label, bool* v, bool hide_label = false);
